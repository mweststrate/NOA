NOA(["noa/base", "noa/cell", "noa/expression", "noa/scopes"], function(base, cell, expression, scopes, NOA) {

    NOA.declare("noa/list", base, {
        ...
        map : function(name, func) {
            ...
            var basescope = scopes.getCurrentScope();
            
            var insert = function(index, value) {
                
                var source = this.parent.cell(index);
                var scope = scopes.newScope(basescope);
                scope[name] = source;
                
                var a = new expression(null, func, scope, this, source); //source will be both available as this.variable('name') or as the first arg in 'func'. 
      ...
      //      debugger;
            ...
            var insert = function(index, value) {
                ...
                if (!list.isA(value)) { //plain value, insert right away
