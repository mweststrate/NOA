NOA(["noa/base", "noa/expression"], function(base, expression, NOA) {

    NOA.declare("noa/cell",  base, {
        parent : null,
        value : undefined,
        index : -1,
        expression : null,
        ...
        _store : function(newvalue) {
            ...
            if (this.expression && newvalue != this.expression || !this.expression && newvalue != orig) {
                ...
                if (expression.isA(newvalue) || NOA.core.Cell.isA(newvalue)) {
        ...
        expressionChanged : function(newvalue, old) {
            ...
            if (NOA.core.Cell.isA(newvalue) || expression.isA(newvalue))
